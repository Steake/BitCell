...
impl Transaction {
    ...
    /// Compute signing hash (excludes signature field)
    /// 
    /// This method computes a hash over the transaction data excluding the signature field.
    /// This hash is what should be signed to create the signature.
